...
export const SALARY_RANGES = [
  { value: 2000, label: '2000만원 이하' },
  { value: 2500, label: '2000-2500만원' },
  { value: 3000, label: '2500-3000만원' },
  { value: 3500, label: '3000-3500만원' },
  { value: 4000, label: '3500-4000만원' },
  { value: 4500, label: '4000-4500만원' },
  { value: 5000, label: '4500-5000만원' },
  { value: 6000, label: '5000-6000만원' },
  { value: 7000, label: '6000-7000만원' },
  { value: 8000, label: '7000만원 이상' },
];
